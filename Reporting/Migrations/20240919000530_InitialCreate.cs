    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConnectionSites", x => x.SiteID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MongoDBCollection = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ElasticIndex = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportLogs", x => x.LogID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportSharings", x => x.ShareID);
                    table.ForeignKey(
                        name: "FK_ReportSharings_ConnectionSites_SiteID",
                        column: x => x.SiteID,
                        principalTable: "ConnectionSites",
                        principalColumn: "SiteID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReportSharings_Reports_ReportID",
                        column: x => x.ReportID,
                        principalTable: "Reports",
                        principalColumn: "ReportID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisualizationType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    XAxisField = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    YAxisField = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AggregationType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReportID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisualizationSettings", x => x.VisualizationID);
                    table.ForeignKey(
                        name: "FK_VisualizationSettings_Reports_ReportID",
                        column: x => x.ReportID,
                        principalTable: "Reports",
                        principalColumn: "ReportID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportSharings_ReportID",
                table: "ReportSharings",
                column: "ReportID");

            migrationBuilder.CreateIndex(
                name: "IX_ReportSharings_SiteID",
                table: "ReportSharings",
                column: "SiteID");

            migrationBuilder.CreateIndex(
                name: "IX_VisualizationSettings_ReportID",
                table: "VisualizationSettings",
                column: "ReportID");
        }
